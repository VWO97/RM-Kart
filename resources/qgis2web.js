...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32632',
            extent: [-198618.130924, 6327232.826624, 1937217.999697, 8141744.746574],
            units: 'm'})
    })
});
...
map.getView().fit([626050.819511, 6658883.601984, 648070.502251, 6674959.566014], map.getSize());
